...
stud_rescale = 1;
//stud_rescale = 1.0475 * 2; // Orion Delta, T-Glase
//stud_rescale = 1.022 * 1; // Orion Delta, ABS

difference(){
union(){
scale(0.43) translate([-228,62,8]) rotate([90, 0 ,0])import("/Users/qubo/Downloads/BASE.STL");
...
//translate([-4,-50,-1]) cube([100,100,100]);
//translate([-120,-50,-1]) cube([120,100,100]);
}
